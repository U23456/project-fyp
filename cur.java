...
public class cur extends AppCompatActivity {
    Button btLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(com.cur.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    getLocation();
                } else {
                    ActivityCompat.requestPermissions(com.cur.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
                }
            }
        });
    }
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<android.location.Location>() {
            ...
            public void onComplete(@NonNull Task<android.location.Location> task) {
                ...
                if(location !=null){
                    ...
                    try {
                        Geocoder geocoder = new Geocoder(com.cur.this, Locale.getDefault());
