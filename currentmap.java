...
public class currentmap extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_currentmap);
        ...
        task.addOnSuccessListener(new OnSuccessListener<android.location.Location>() {
            ...
            public void onSuccess(android.location.Location location) {
                if(location !=null){
                    ...
                    SupportMapFragment supportMapFragment =(SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.googlem);
                    supportMapFragment.getMapAsync(com.currentmap.this);
